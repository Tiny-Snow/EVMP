# -*- coding:UTF-8 -*-
# Author:   Tiny Snow
# Project:  Extended Vision Mutation Priority Promoter Encoder Framework (1DCNN ResNet)
# Time:     2022.7.12
...
save_train = BASE_DIR + '/output/EVMP-1DCNN(ResNet).pdf'.format(info)     # save train/valid figure path
