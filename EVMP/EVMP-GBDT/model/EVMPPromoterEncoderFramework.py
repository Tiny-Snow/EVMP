# -*- coding:UTF-8 -*-
# Author:   Tiny Snow
# Project:  Extended Vision Mutation Priority Promoter Encoder Framework (GBDT)
# Time:     2022.7.11
...
def run(x_train, y_train, x_valid, y_valid, x_test, y_test, idx = 0):
    '''
    ...
    # plot and save
    result = output(y_train, pred_train, y_valid, pred_valid, y_test, pred_test, file_name = 'EVMP-GBDT', idx = idx)
