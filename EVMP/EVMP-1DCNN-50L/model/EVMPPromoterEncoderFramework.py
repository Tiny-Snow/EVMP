# -*- coding:UTF-8 -*-
# Author:   Tiny Snow
# Project:  Extended Vision Mutation Priority Promoter Encoder Framework (1DCNN 50 layers)
# Time:     2022.7.12
...
def run(train_loader, val_loader, test_loader, predict_loader = None):
    ...
    result = output(y_train, pred_train, y_valid, pred_valid, y_test, pred_test, file_name = 'EVMP-1DCNN-50L')
