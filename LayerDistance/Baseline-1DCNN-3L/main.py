...
from model.Baseline1DCNN import run


if __name__ == '__main__':
    # load data
    log('>>>>> Loading data ...')
    train_loader, val_loader, test_loader, predict_loader, base_loader = load_data()
    ...
    # train
    run(train_loader, val_loader, test_loader, predict_loader, base_loader)
