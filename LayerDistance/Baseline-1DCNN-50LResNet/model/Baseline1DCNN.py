...
class Baseline1DCNN(nn.Module):
    ...
    def __init__(self, device, seq_len, input_size, hidden_size = [1024, 128, 1024, 128]):
        ...
        self.fc = nn.Linear(in_features = hidden_size[-2] * seq_len, out_features = 1)
...
def output(y_train, pred_train, y_test, pred_test, file_name = '1DCNN (50 layers + ResNet)'):
...
def dis_plot(avgs, ups, downs):
    ...
    plt.title('1DCNN (50 layers + ResNet)')
